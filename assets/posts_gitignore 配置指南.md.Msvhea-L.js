import{G as e,W as t,ct as n,it as r,n as i,q as a}from"./chunks/framework.2K1covnI.js";var o=JSON.parse(`{"title":".gitignore 配置指南","description":"通用的、可复用、可标准化的 .gitignore 配置指南，适用于各种类型的项目，提供分层管理策略和最佳实践","frontmatter":{"title":".gitignore 配置指南","description":"通用的、可复用、可标准化的 .gitignore 配置指南，适用于各种类型的项目，提供分层管理策略和最佳实践","date":"2025-12-01T14:43:20.000Z","tags":["Git","工程化"]},"headers":[],"relativePath":"posts/gitignore 配置指南.md","filePath":"posts/gitignore 配置指南.md","lastUpdated":1764670496000}`),s={name:`posts/gitignore 配置指南.md`};function c(i,o,s,c,l,u){let d=n(`MermaidDiagram`);return r(),t(`div`,null,[o[0]||=e(`<blockquote><p>基于实际项目经验，总结通用的 <code>.gitignore</code> 配置原则和最佳实践，提供可复用的、标准化的配置方案，适用于各种类型的项目。</p></blockquote><h2 id="一、核心原则" tabindex="-1">一、核心原则 <a class="header-anchor" href="#一、核心原则" aria-label="Permalink to “一、核心原则”">​</a></h2><h3 id="_1-1-为什么需要-gitignore" tabindex="-1">1.1 为什么需要 .gitignore <a class="header-anchor" href="#_1-1-为什么需要-gitignore" aria-label="Permalink to “1.1 为什么需要 .gitignore”">​</a></h3><p><code>.gitignore</code> 用于告诉 Git 哪些文件或目录不应该被版本控制。核心原则：</p><ul><li><strong>不提交生成文件</strong>：构建产物、编译文件等由工具生成，不应提交</li><li><strong>不提交依赖目录</strong>：依赖由包管理器管理，通过声明文件（如 <code>package.json</code>）管理版本</li><li><strong>不提交敏感信息</strong>：环境变量、密钥、密码等敏感信息不应提交</li><li><strong>不提交个人配置</strong>：IDE 配置、系统文件等个人偏好不应影响团队</li></ul><h3 id="_1-2-配置策略" tabindex="-1">1.2 配置策略 <a class="header-anchor" href="#_1-2-配置策略" aria-label="Permalink to “1.2 配置策略”">​</a></h3><p>根据项目复杂度选择配置策略：</p><table tabindex="0"><thead><tr><th>策略</th><th>适用场景</th><th>结构</th></tr></thead><tbody><tr><td><strong>单文件管理</strong></td><td>单一技术栈、小型项目</td><td>项目根目录一个 <code>.gitignore</code></td></tr><tr><td><strong>分层管理</strong></td><td>多技术栈、中大型项目</td><td>根目录通用规则 + 子目录特定规则</td></tr></tbody></table>`,8),a(d,{source:``}),o[1]||=e(`<h3 id="_1-3-分类组织原则" tabindex="-1">1.3 分类组织原则 <a class="header-anchor" href="#_1-3-分类组织原则" aria-label="Permalink to “1.3 分类组织原则”">​</a></h3><p>按类别组织规则，使用注释清晰标注：</p><ul><li><strong>数据目录</strong>：运行时数据（<code>data/</code>、<code>logs/</code>、<code>uploads/</code>）</li><li><strong>配置文件</strong>：环境变量、本地配置（<code>*.env</code>、<code>*.local</code>）</li><li><strong>构建产物</strong>：编译输出、打包文件（<code>dist/</code>、<code>build/</code>、<code>target/</code>）</li><li><strong>依赖目录</strong>：包管理器安装的依赖（<code>node_modules/</code>、<code>venv/</code>、<code>vendor/</code>）</li><li><strong>测试覆盖率</strong>：测试报告、覆盖率数据（<code>coverage/</code>、<code>.coverage</code>）</li><li><strong>IDE 配置</strong>：编辑器配置文件（<code>.vscode/</code>、<code>.idea/</code>）</li><li><strong>系统文件</strong>：操作系统生成的文件（<code>.DS_Store</code>、<code>Thumbs.db</code>）</li><li><strong>日志和临时文件</strong>：运行时日志、临时文件（<code>*.log</code>、<code>*.tmp</code>）</li></ul><h2 id="二、模板集合" tabindex="-1">二、模板集合 <a class="header-anchor" href="#二、模板集合" aria-label="Permalink to “二、模板集合”">​</a></h2><h3 id="_2-1-通用项目模板" tabindex="-1">2.1 通用项目模板 <a class="header-anchor" href="#_2-1-通用项目模板" aria-label="Permalink to “2.1 通用项目模板”">​</a></h3><p><strong>位置：</strong> <code>project-root/.gitignore</code><br><strong>适用场景：</strong> 所有项目的通用规则</p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># ============================================</span></span>
...
<span class="line"><span># ============================================</span></span>
<span class="line"><span>docker-compose.override.yml</span></span></code></pre></div><h3 id="_2-2-node-js-javascript-typescript-项目" tabindex="-1">2.2 Node.js / JavaScript / TypeScript 项目 <a class="header-anchor" href="#_2-2-node-js-javascript-typescript-项目" aria-label="Permalink to “2.2 Node.js / JavaScript / TypeScript 项目”">​</a></h3><p><strong>完整模板：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># ============================================</span></span>
...
<span class="line"><span>*.sln</span></span></code></pre></div><h3 id="_2-3-python-项目" tabindex="-1">2.3 Python 项目 <a class="header-anchor" href="#_2-3-python-项目" aria-label="Permalink to “2.3 Python 项目”">​</a></h3><p><strong>完整模板：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># ============================================</span></span>
...
<span class="line"><span>*.db-journal</span></span></code></pre></div><h3 id="_2-4-java-项目" tabindex="-1">2.4 Java 项目 <a class="header-anchor" href="#_2-4-java-项目" aria-label="Permalink to “2.4 Java 项目”">​</a></h3><p><strong>完整模板：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># ============================================</span></span>
...
<span class="line"><span>.classpath</span></span>
<span class="line"><span>.project</span></span>
<span class="line"><span>.settings/</span></span></code></pre></div><h3 id="_2-5-go-项目" tabindex="-1">2.5 Go 项目 <a class="header-anchor" href="#_2-5-go-项目" aria-label="Permalink to “2.5 Go 项目”">​</a></h3><p><strong>完整模板：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># ============================================</span></span>
<span class="line"><span># 编译文件</span></span>
<span class="line"><span># ============================================</span></span>
...
<span class="line"><span>.idea/</span></span>
<span class="line"><span>*.swp</span></span>
<span class="line"><span>*.swo</span></span></code></pre></div><h3 id="_2-6-rust-项目" tabindex="-1">2.6 Rust 项目 <a class="header-anchor" href="#_2-6-rust-项目" aria-label="Permalink to “2.6 Rust 项目”">​</a></h3><p><strong>完整模板：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># ============================================</span></span>
<span class="line"><span># 编译文件</span></span>
<span class="line"><span># ============================================</span></span>
<span class="line"><span>target/</span></span>
...
<span class="line"><span>.idea/</span></span>
<span class="line"><span>*.swp</span></span>
<span class="line"><span>*.swo</span></span></code></pre></div><h3 id="_2-7-移动端项目" tabindex="-1">2.7 移动端项目 <a class="header-anchor" href="#_2-7-移动端项目" aria-label="Permalink to “2.7 移动端项目”">​</a></h3><h4 id="ios" tabindex="-1">iOS <a class="header-anchor" href="#ios" aria-label="Permalink to “iOS”">​</a></h4><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>*.pbxuser</span></span>
...
<span class="line"><span>*.dSYM</span></span></code></pre></div><h4 id="android" tabindex="-1">Android <a class="header-anchor" href="#android" aria-label="Permalink to “Android”">​</a></h4><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>*.apk</span></span>
...
<span class="line"><span>out/</span></span></code></pre></div><h3 id="_2-8-分层配置示例" tabindex="-1">2.8 分层配置示例 <a class="header-anchor" href="#_2-8-分层配置示例" aria-label="Permalink to “2.8 分层配置示例”">​</a></h3><p><strong>场景：</strong> Vue3 + FastAPI 全栈项目</p><p><strong>项目结构：</strong></p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>project-root/</span></span>
...
<span class="line"><span>    └── ...</span></span></code></pre></div><p><strong>根目录 <code>.gitignore</code>：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 通用规则</span></span>
<span class="line"><span>data/</span></span>
<span class="line"><span>logs/</span></span>
<span class="line"><span>uploads/</span></span>
<span class="line"><span>*.env</span></span>
...
<span class="line"><span>Thumbs.db</span></span>
<span class="line"><span>*.log</span></span>
<span class="line"><span>*.tmp</span></span></code></pre></div><p><strong><code>frontend/.gitignore</code>：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 前端特定规则</span></span>
<span class="line"><span>node_modules/</span></span>
<span class="line"><span>.pnpm-store/</span></span>
<span class="line"><span>.yarn/</span></span>
<span class="line"><span>dist/</span></span>
...
<span class="line"><span>coverage/</span></span>
<span class="line"><span>.env</span></span>
<span class="line"><span>.env.local</span></span></code></pre></div><p><strong><code>backend/.gitignore</code>：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 后端特定规则</span></span>
<span class="line"><span>__pycache__/</span></span>
...
<span class="line"><span>*.sqlite</span></span>
<span class="line"><span>.env</span></span>
<span class="line"><span>.env.local</span></span></code></pre></div><h2 id="三、最佳实践" tabindex="-1">三、最佳实践 <a class="header-anchor" href="#三、最佳实践" aria-label="Permalink to “三、最佳实践”">​</a></h2><h3 id="_3-1-敏感信息管理" tabindex="-1">3.1 敏感信息管理 <a class="header-anchor" href="#_3-1-敏感信息管理" aria-label="Permalink to “3.1 敏感信息管理”">​</a></h3><p><strong>环境变量文件：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 忽略所有环境变量文件</span></span>
<span class="line"><span>*.env</span></span>
<span class="line"><span>*.env.local</span></span>
<span class="line"><span>*.env.*.local</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>!logs/.gitkeep</span></span></code></pre></div><p><strong>规则优先级：</strong></p><ol><li>更具体的规则优先于通用规则</li><li>后面的规则可以覆盖前面的规则（使用 <code>!</code>）</li><li>目录规则会忽略目录中的所有文件</li></ol><h2 id="四、常见问题处理" tabindex="-1">四、常见问题处理 <a class="header-anchor" href="#四、常见问题处理" aria-label="Permalink to “四、常见问题处理”">​</a></h2><h3 id="_4-1-已提交的文件需要忽略" tabindex="-1">4.1 已提交的文件需要忽略 <a class="header-anchor" href="#_4-1-已提交的文件需要忽略" aria-label="Permalink to “4.1 已提交的文件需要忽略”">​</a></h3><p><strong>问题：</strong> 文件已经被 Git 跟踪，但需要添加到 <code>.gitignore</code></p><p><strong>解决方案：</strong></p><div class="language-bash"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#62687b;--shiki-dark:#818e99;"># 从 Git 中移除但保留本地文件</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> rm</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --cached</span><span style="--shiki-light:#c62739;--shiki-dark:#F97583;"> &lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">fil</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">e</span><span style="--shiki-light:#c62739;--shiki-dark:#F97583;">&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#62687b;--shiki-dark:#818e99;"># 对于目录</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> rm</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -r</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --cached</span><span style="--shiki-light:#c62739;--shiki-dark:#F97583;"> &lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">director</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">y</span><span style="--shiki-light:#c62739;--shiki-dark:#F97583;">&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#62687b;--shiki-dark:#818e99;"># 提交更改</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> commit</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -m</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Remove tracked files from Git&quot;</span></span></code></pre></div><p><strong>批量处理：</strong></p><div class="language-bash"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#62687b;--shiki-dark:#818e99;"># 移除所有已跟踪的 .env 文件</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#62687b;--shiki-dark:#818e99;"># .gitignore 中排除 .gitkeep</span></span>
<span class="line"><span style="--shiki-light:#c62739;--shiki-dark:#F97583;">!**</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">/.gitkeep</span></span></code></pre></div><p><strong>配置示例：</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 忽略目录中的所有文件</span></span>
...
<span class="line"><span>!**/.gitkeep</span></span></code></pre></div><h3 id="_4-4-部分文件需要提交" tabindex="-1">4.4 部分文件需要提交 <a class="header-anchor" href="#_4-4-部分文件需要提交" aria-label="Permalink to “4.4 部分文件需要提交”">​</a></h3><p><strong>问题：</strong> 某个模式的文件需要忽略，但其中某些文件需要提交</p><p><strong>解决方案：</strong> 使用 <code>!</code> 取消忽略</p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 忽略所有 .env 文件</span></span>
<span class="line"><span>*.env</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>!changelog.log</span></span></code></pre></div><h3 id="_4-5-跨平台路径问题" tabindex="-1">4.5 跨平台路径问题 <a class="header-anchor" href="#_4-5-跨平台路径问题" aria-label="Permalink to “4.5 跨平台路径问题”">​</a></h3><p><strong>问题：</strong> Windows 和 Linux/macOS 路径分隔符不同</p><p><strong>解决方案：</strong> 使用 <code>/</code> 作为路径分隔符（Git 会自动处理）</p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># ✅ 正确（跨平台）</span></span>
<span class="line"><span>data/logs/</span></span>
<span class="line"><span>config/*.env</span></span>
<span class="line"><span></span></span>
<span class="line"><span># ❌ 错误（Windows 特定）</span></span>
<span class="line"><span>data\\logs\\</span></span>
<span class="line"><span>config\\*.env</span></span></code></pre></div><h2 id="五、团队协作建议" tabindex="-1">五、团队协作建议 <a class="header-anchor" href="#五、团队协作建议" aria-label="Permalink to “五、团队协作建议”">​</a></h2><h3 id="_5-1-统一配置" tabindex="-1">5.1 统一配置 <a class="header-anchor" href="#_5-1-统一配置" aria-label="Permalink to “5.1 统一配置”">​</a></h3><p><strong>原则：</strong></p><ul><li>团队成员使用相同的 <code>.gitignore</code> 配置</li><li><code>.gitignore</code> 文件应该提交到版本控制</li><li>定期审查和更新 <code>.gitignore</code> 配置</li></ul><p><strong>实践：</strong></p><ol><li>在项目初始化时创建 <code>.gitignore</code></li><li>使用模板或参考最佳实践</li><li>在 README 中说明 <code>.gitignore</code> 的配置原则</li><li>定期审查是否有遗漏的规则</li></ol><h3 id="_5-2-文档说明" tabindex="-1">5.2 文档说明 <a class="header-anchor" href="#_5-2-文档说明" aria-label="Permalink to “5.2 文档说明”">​</a></h3><p><strong>建议在 README 中说明：</strong></p><ul><li><code>.gitignore</code> 的配置原则</li><li>哪些文件/目录被忽略及原因</li><li>如何添加新的忽略规则</li><li>如何处理已提交的文件</li></ul><p><strong>示例：</strong></p><div class="language-markdown"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">## .gitignore 配置说明</span></span>
<span class="line"></span>
