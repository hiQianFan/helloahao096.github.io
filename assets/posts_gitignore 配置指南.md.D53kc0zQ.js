import{_ as p,C as l,c as e,o as i,aa as n,G as t}from"./chunks/framework.tkU0Ryf1.js";const b=JSON.parse('{"title":".gitignore 配置指南","description":"通用的、可复用、可标准化的 .gitignore 配置指南，适用于各种类型的项目，提供分层管理策略和最佳实践","frontmatter":{"title":".gitignore 配置指南","description":"通用的、可复用、可标准化的 .gitignore 配置指南，适用于各种类型的项目，提供分层管理策略和最佳实践","date":"2025-12-01T14:43:20.000Z","tags":["Git","工程化"]},"headers":[],"relativePath":"posts/gitignore 配置指南.md","filePath":"posts/gitignore 配置指南.md","lastUpdated":1764670496000}'),c={name:"posts/gitignore 配置指南.md"};function o(d,s,r,h,g,k){const a=l("MermaidDiagram");return i(),e("div",null,[s[0]||(s[0]=n('<blockquote><p>基于实际项目经验，总结通用的 <code>.gitignore</code> 配置原则和最佳实践，提供可复用的、标准化的配置方案，适用于各种类型的项目。</p></blockquote><h2 id="一、核心原则" tabindex="-1">一、核心原则 <a class="header-anchor" href="#一、核心原则" aria-label="Permalink to &quot;一、核心原则&quot;">​</a></h2><h3 id="_1-1-为什么需要-gitignore" tabindex="-1">1.1 为什么需要 .gitignore <a class="header-anchor" href="#_1-1-为什么需要-gitignore" aria-label="Permalink to &quot;1.1 为什么需要 .gitignore&quot;">​</a></h3><p><code>.gitignore</code> 用于告诉 Git 哪些文件或目录不应该被版本控制。核心原则：</p><ul><li><strong>不提交生成文件</strong>：构建产物、编译文件等由工具生成，不应提交</li><li><strong>不提交依赖目录</strong>：依赖由包管理器管理，通过声明文件（如 <code>package.json</code>）管理版本</li><li><strong>不提交敏感信息</strong>：环境变量、密钥、密码等敏感信息不应提交</li><li><strong>不提交个人配置</strong>：IDE 配置、系统文件等个人偏好不应影响团队</li></ul><h3 id="_1-2-配置策略" tabindex="-1">1.2 配置策略 <a class="header-anchor" href="#_1-2-配置策略" aria-label="Permalink to &quot;1.2 配置策略&quot;">​</a></h3><p>根据项目复杂度选择配置策略：</p><table tabindex="0"><thead><tr><th>策略</th><th>适用场景</th><th>结构</th></tr></thead><tbody><tr><td><strong>单文件管理</strong></td><td>单一技术栈、小型项目</td><td>项目根目录一个 <code>.gitignore</code></td></tr><tr><td><strong>分层管理</strong></td><td>多技术栈、中大型项目</td><td>根目录通用规则 + 子目录特定规则</td></tr></tbody></table>',8)),t(a,{source:""}),s[1]||(s[1]=n(`<h3 id="_1-3-分类组织原则" tabindex="-1">1.3 分类组织原则 <a class="header-anchor" href="#_1-3-分类组织原则" aria-label="Permalink to &quot;1.3 分类组织原则&quot;">​</a></h3><p>按类别组织规则，使用注释清晰标注：</p><ul><li><strong>数据目录</strong>：运行时数据（<code>data/</code>、<code>logs/</code>、<code>uploads/</code>）</li><li><strong>配置文件</strong>：环境变量、本地配置（<code>*.env</code>、<code>*.local</code>）</li><li><strong>构建产物</strong>：编译输出、打包文件（<code>dist/</code>、<code>build/</code>、<code>target/</code>）</li><li><strong>依赖目录</strong>：包管理器安装的依赖（<code>node_modules/</code>、<code>venv/</code>、<code>vendor/</code>）</li><li><strong>测试覆盖率</strong>：测试报告、覆盖率数据（<code>coverage/</code>、<code>.coverage</code>）</li><li><strong>IDE 配置</strong>：编辑器配置文件（<code>.vscode/</code>、<code>.idea/</code>）</li><li><strong>系统文件</strong>：操作系统生成的文件（<code>.DS_Store</code>、<code>Thumbs.db</code>）</li><li><strong>日志和临时文件</strong>：运行时日志、临时文件（<code>*.log</code>、<code>*.tmp</code>）</li></ul><h2 id="二、模板集合" tabindex="-1">二、模板集合 <a class="header-anchor" href="#二、模板集合" aria-label="Permalink to &quot;二、模板集合&quot;">​</a></h2><h3 id="_2-1-通用项目模板" tabindex="-1">2.1 通用项目模板 <a class="header-anchor" href="#_2-1-通用项目模板" aria-label="Permalink to &quot;2.1 通用项目模板&quot;">​</a></h3><p><strong>位置：</strong> <code>project-root/.gitignore</code><br><strong>适用场景：</strong> 所有项目的通用规则</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># ============================================</span></span>
